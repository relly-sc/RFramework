    ...
    public static partial class Utility
    {
        ...
        public static partial class Compression
        {
            ...
            public static bool Compress(byte[] bytes, int offset, int length, Stream compressedStream)
            {
                ...
                {
                    throw new RFrameworkException("Compressed helper is invalid.");
                }
                ...
                {
                    throw new RFrameworkException("Compressed stream is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new RFrameworkException(Text.Format("Can not compress with exception '{0}'.", exception), exception);
                }
            }
            ...
            public static bool Decompress(byte[] bytes, int offset, int length, Stream decompressedStream)
            {
                ...
                {
                    throw new RFrameworkException("Decompressed stream is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new RFrameworkException(Text.Format("Can not decompress with exception '{0}'.", exception), exception);
                }
            }
