...
namespace RFramework.Scene
{
    ...
    internal sealed class SceneModule : RFrameworkModule, ISceneModule
    {
        ...
        public async Task LoadSceneAsync(string assetName, SceneLoadMode sceneMode = SceneLoadMode.Single,
            ...
            CancellationToken ct = default)
        {
            ...
            try
            {
                await resourceModule.LoadSceneAsync(assetName, sceneMode, activateOnLoad, priority);
